...
In Muvx, a **Destination** represents a delivery provider (such as Beep Beep, Quick Delivery co, Seeda or even the Autobot simulator) where your shipments are dispatched. Once connected, you can link your sources to a destination and start routing orders.
