...
please refer to the [Muvx Platforms Integrations Postman documentation](/documentation/postman-platforms).
...
<Banner title="Getting Your Client Credentials">
  Before you can request an access token, you need to create a regular Muvx account and contact the Muvx support team to obtain your <code>client_id</code> and <code>client_secret</code> credentials.
</Banner>
...
Please refer to the [Muvx Order Management documentation](/documentation/api-order-management).
