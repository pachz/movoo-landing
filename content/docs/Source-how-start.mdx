...
rank: "1"
slug: "admin-panel-manual-source-start"
next: "admin-panel-manual-source-details"
prev: "what-is-muvx-glossary"
---

This manual is specifically designed for **ECs & Businesses** using the Muvx platform.  
While delivery providers are responsible for executing and completing shipments, ECs create and manage the orders that flow into the system.  

If you are looking for the **Admin Panel Manual for Delivery Providers**, please refer to this link:  
[Admin Panel Manual for Delivery Providers](/documentation/admin-panel-manual-delivery-provider)
