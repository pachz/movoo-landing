...
import Stripes from "@/public/images/stripes-dark copy.svg";
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        >
          ...
          <div
            ...
            aria-hidden="true"
          >
            <div className="h-56 w-[480px] rounded-full border-[20px] border-primary-500 blur-3xl will-change-[filter]" />
          </div>
