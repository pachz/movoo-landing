    ...
    <div className="mt-10 border-t border-gray-200 pt-10 text-center md:text-left">
      ...
      <form>
        <div className="mx-auto flex max-w-sm flex-col justify-center sm:max-w-none sm:flex-row md:justify-start">
          ...
          <button
            className="btn whitespace-nowrap bg-linear-to-t from-blue-600 to-primary-500 bg-[length:100%_100%] bg-[bottom] text-white shadow-sm hover:bg-[length:100%_150%]"
            type="submit"
          >
            Subscribe
          </button>
