  ...
  return (
    <article className="pl-6 sm:pl-10">
      <header className="mb-2">
        <div className="relative mb-2 flex items-center gap-2 before:absolute before:inset-y-0 before:-left-6 before:-ml-px before:w-px before:bg-primary-500 sm:before:-left-10">
          <Image
