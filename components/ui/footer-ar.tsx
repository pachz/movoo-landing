...
export default function FooterAr({ border = false }: { border?: boolean }) {
  return (
    <footer>
        ...
        >
          ...
          <div className="space-y-2 sm:col-span-12 lg:col-span-4">
            ...
            <div className="text-sm text-gray-600">
              &copy; 2025 موفو - جميع الحقوق محفوظة.
            </div>
          </div>

          {/* 2nd block */}
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-sm font-medium">الصفحات</h3>
          ...
          {/* 5th block */}
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-sm font-medium">التواصل الاجتماعي</h3>
      ...
      <div className="relative -mt-16 h-60 w-full -z-10" aria-hidden="true">
        <div className="pointer-events-none absolute left-1/2 -z-10 -translate-x-1/2 text-center text-[348px] font-bold leading-none before:bg-linear-to-b before:from-gray-200 before:to-gray-100/30 before:to-80% before:bg-clip-text before:text-transparent before:content-['Muvu'] after:absolute after:inset-0 after:bg-gray-300/70 after:bg-clip-text after:text-transparent after:mix-blend-darken after:content-['Muvu'] after:[text-shadow:0_1px_0_white]"></div>
        {/* Glow */}
        <div
          className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-2/3"
          aria-hidden="true"
        >
          <div className="h-56 w-56 rounded-full border-[20px] border-primary-700 blur-[80px] will-change-[filter]"></div>
        </div>
      </div>
    </footer>
  );
