      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-10 pb-12 md:pb-20">
          ...
          <div className="grid md:grid-cols-6">
            ...
            {/* Usage label */}
            <div className="hidden md:flex flex-col justify-center px-4 md:px-6 py-2 bg-slate-700/25 md:col-span-3">
              <span className="text-xs uppercase font-semibold text-slate-500">Usage</span>
            </div>
            <div className="flex flex-col justify-center px-4 md:px-6 py-2 bg-slate-700/25 md:border-l border-slate-700 order-1 md:order-none">
              <span className="md:hidden text-xs uppercase font-semibold text-slate-500">Usage</span>
            </div>
            <div className="flex flex-col justify-center px-4 md:px-6 py-2 bg-slate-700/25 md:border-l border-slate-700 order-2 md:order-none">
              <span className="md:hidden text-xs uppercase font-semibold text-slate-500">Usage</span>
            </div>
            <div className="flex flex-col justify-center px-4 md:px-6 py-2 bg-slate-700/25 md:border-l border-slate-700 order-3 md:order-none">
              <span className="md:hidden text-xs uppercase font-semibold text-slate-500">Usage</span>
            </div>
            {/* Admins & Members */}
            ...
            {/* File Storage */}
            <div className="hidden md:flex flex-col justify-center p-4 md:px-6 bg-slate-800/70 md:col-span-3">
              <div className="text-slate-200">File Storage</div>
            </div>
            <div className="flex justify-between md:flex-col md:justify-center p-4 md:px-6 bg-slate-800/70 md:border-l border-slate-700 order-1 md:order-none">
            ...
            <div className="flex justify-between md:flex-col md:justify-center p-4 md:px-6 bg-slate-800/70 md:border-l border-slate-700 order-2 md:order-none">
              <div className="md:hidden text-slate-200">File Storage</div>
              <div className="text-sm font-medium text-slate-200 text-center">50GB</div>
            </div>
            <div className="flex justify-between md:flex-col md:justify-center p-4 md:px-6 bg-slate-800/70 md:border-l border-slate-700 order-3 md:order-none">
              <div className="md:hidden text-slate-200">File Storage</div>
              <div className="text-sm font-medium text-slate-200 text-center">Unlimited</div>
            </div>
            {/* Active Users */}
            ...
            {/* CTA row */}
            <div className="hidden md:flex flex-col justify-center px-4 md:px-6 py-2 bg-slate-700/25 md:col-span-3" />
            <div className="flex flex-col justify-center p-4 bg-slate-700/25 md:border-l border-slate-700 order-1 md:order-none">
              <a className="btn-sm text-white bg-indigo-500 hover:bg-indigo-600 w-full shadow-xs group whitespace-nowrap" href="#0">
                Free Trial{' '}
            ...
            <div className="flex flex-col justify-center p-4 bg-slate-700/25 md:border-l border-slate-700 order-2 md:order-none">
              <a className="btn-sm text-white bg-indigo-500 hover:bg-indigo-600 w-full shadow-xs group whitespace-nowrap" href="#0">
                Free Trial{' '}
                <span className="hidden lg:block tracking-normal text-sky-300 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">
                  -&gt;
            ...
            <div className="flex flex-col justify-center p-4 bg-slate-700/25 md:border-l border-slate-700 order-3 md:order-none">
              <a className="btn-sm text-white bg-indigo-500 hover:bg-indigo-600 w-full shadow-xs group whitespace-nowrap" href="#0">
                Free Trial{' '}
                <span className="hidden lg:block tracking-normal text-sky-300 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">
                  -&gt;
